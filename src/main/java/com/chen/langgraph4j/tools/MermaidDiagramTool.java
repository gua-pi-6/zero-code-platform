package com.chen.langgraph4j.tools;
...
import com.chen.langgraph4j.model.enums.ImageCategoryEnum;
...
public class MermaidDiagramTool {
    ...
    public List<ImageResource> generateMermaidDiagram(@P("Mermaid 图表代码") String mermaidCode,
        ...
        try {
            ...
            String cosUrl = cosManager.uploadFileToCos(diagramFile, keyName);
            // 清理临时文件
